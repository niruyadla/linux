...
//nyadla@commented below line
			...
			case ID_AUDIO_AP_FADE_OUT_REQ:
			{
//nyadla:commented below line review
...
if ((NULL != dspon) &&(NULL != dsploadindicate)) {
    ...
    printk("Cadence_Linaro_Debug %s Before Calling DRV_IPCIntInit() \n",__func__);

	ret = DRV_IPCIntInit();
    
    printk("Cadence_Linaro_Debug %s After Calling DRV_IPCIntInit() \n",__func__);
