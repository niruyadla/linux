...
#if 0 /*KERNEL_VERSION(4, 6, 0) > LINUX_VERSION_CODE*/
/*
...
static int kbase_platform_device_probe(struct platform_device *pdev)
{
	...
	if (kbase_has_hi_feature(kbdev, KBASE_FEATURE_HI0006)) {
		...
		//read 0x264 and set it's [3:0] and [19:16]bit to 0,enable G3D HPM hardware status contrl
		...
		//read 0x46c and set it's [26]bit to 1,enable L2 reduce freq when it IDLE
